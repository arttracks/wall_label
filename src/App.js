  ...
  return (
      <div className="TOC">
        ...
        <div className='credits'>
          <p>
            This is part of <a href='http://www.museumprovenance.org' target='_blank'>Art Tracks</a>, a project of <a href='http://cmoa.org' target='_blank'>Carnegie Museum of Art</a>.
          </p>
          <p>
            Source code for this project is available under a <a href='https://opensource.org/licenses/MIT' target='_blank'>MIT license</a> on <a href='https://github.com/arttracks/wall_label' target='_blank'> Github</a> for download, modification, or reuse.  All written content is released under a <a href='https://creativecommons.org/publicdomain/zero/1.0/' target='_blank'> Creative Commons 1.0 Universal</a> license for reuse.
          </p>
          <p>
            Thank you to <a href='https://www.netlify.com' target='_blank'>Netlify</a> for providing free hosting to this project and other open-source software.
          </p>
          <p>
